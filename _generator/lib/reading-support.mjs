...
export function validateReadingSupport(edition,data=catalog){
 ...
 for(const x of data.editions[edition.brief_date]||[]){
  ...
  if(!['New development','Update','Background'].includes(x.coverage_label)||!x.label_reason||!x.context_term||!x.context)throw Error('Reading support requires reviewed labels and context');
