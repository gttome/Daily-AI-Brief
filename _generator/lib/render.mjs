...
export function renderSubscriptionCard(){return `<section id="subscribe" class="subscription-card" aria-labelledby="subscribe-title"><h2 id="subscribe-title">Follow the daily brief</h2><p>Get one entry per day in your feed reader. Choose any date to read its complete archived brief.</p><label for="rss-home-address">Daily edition feed address</label><input id="rss-home-address" class="rss-address" readonly value="https://gttome.github.io/Daily-AI-Brief/daily-feed.xml"><p><button type="button" class="rss-copy" hidden>Copy feed address</button> <button type="button" class="rss-help-open" hidden>How to subscribe</button></p><p class="rss-copy-status" role="status"></p><p>No email address or account on this site needed.</p><p><a href="{{ '/daily-feed.xml' | relative_url }}">Open daily edition RSS feed</a> · <a href="{{ '/subscribe/' | relative_url }}">Subscription instructions</a></p></section>`;}
