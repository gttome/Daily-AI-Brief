...
const freshMetadataCount=()=>[...candidates.values()].filter(c=>{
 ...
 const required=c.required_topic&&Number.isFinite(updated)&&Date.now()-updated>=0&&Date.now()-updated<=(c.required_topic_fallback_days||7)*86400000;
