...
<span class="story-editorial-note" data-george-implication="This supports a useful distinction for courses: reusable agent procedures need both a packaging layer and a governance layer. A workshop exercise could define who may publish a skill or plugin, how changes are reviewed, and when automatic adoption is acceptable." hidden></span>
