---
layout: default
title: "Fabric data agents become reusable tools inside low-code Copilot Studio agents"
description: "Microsoft made the integration generally available for adding a Fabric data agent as a tool inside a Copilot Studio agent. The Fabric agent continues to run against governed data in Fabric and applies underlying data permissions, while the Copilot Studio agent can use that specialist data capability alongside other tools and publish the resulting experience to channels such as Microsoft Teams or Microsoft 365 Copilot."
image: "https://raw.githubusercontent.com/gttome/Daily-AI-Brief/main/briefs/images/2026-09-04/06-fabric-copilot.svg?v=20260904-5"
permalink: /stories/2026-09-04/fabric-data-agents-become-reusable-tools-inside-low-code-copilot-studio-agents/
brief_date: 2026-09-04
story_id: dab-story-2026-09-04-2c938c91
---
...
<span class="story-data" data-story-id="dab-story-2026-09-04-2c938c91" hidden></span>
...
**Source:** [Microsoft Learn — Add a Fabric data agent as a tool in Microsoft Copilot Studio](https://learn.microsoft.com/en-us/fabric/data-science/data-agent-microsoft-copilot-studio-tool)
