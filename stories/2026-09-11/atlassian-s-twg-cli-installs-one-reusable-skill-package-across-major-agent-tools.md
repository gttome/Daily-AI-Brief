...
<span class="story-editorial-note" data-george-implication="Package one recurring book, workshop, or consulting workflow as a small reviewed skill. Keep references modular, test it in two runtimes, compare outputs and permissions, and version the package before sharing it." hidden></span>
