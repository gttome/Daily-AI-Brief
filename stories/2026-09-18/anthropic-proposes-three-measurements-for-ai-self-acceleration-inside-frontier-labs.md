...
# Anthropic proposes three measurements for AI self-acceleration inside frontier labs
...
<span class="story-data" data-story-id="dab-story-2026-09-18-2cda8d5e" hidden></span>
...
**Track operational capability and control together:** When evaluating an agentic engineering system, pair productivity or automation metrics with monitor coverage, review latency, escalation rates, and the scope of human intervention.
