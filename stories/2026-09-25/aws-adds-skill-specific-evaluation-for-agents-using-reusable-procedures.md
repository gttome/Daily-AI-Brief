...
# AWS adds skill-specific evaluation for agents using reusable procedures
...
<span class="story-data" data-story-id="dab-story-2026-09-25-e2f16170" hidden></span>
...
**Test one reusable skill for selection and instruction fidelity:** Create representative tasks, measure whether the agent invokes the correct skill, and verify that required steps are followed before scaling.
